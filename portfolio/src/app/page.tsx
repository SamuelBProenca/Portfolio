        ...
        <section className="grid gap-10 pb-16 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-6 text-sm text-slate-400">
              ...
              <a href="mailto:samuelbrito782@gmail.com" className="transition hover:text-white">Email</a>
            </div>
          </div>
        ...
        <section id="contact" className="mt-16 overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-r from-blue-500/10 via-white/[0.03] to-emerald-500/10 p-8 md:p-10">
          <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-end">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <a href="mailto:samuelbrito782@gmail.com" className="rounded-2xl border border-white/10 bg-white/5 px-5 py-3 font-medium text-slate-100 transition hover:bg-white/10">
                Email
              </a>
            </div>
          </div>
